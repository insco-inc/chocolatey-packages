...
# add headers
$headers = @{
    "Authorization" = "Bearer $Env:CYF_RELEASE_TOKEN"
    "Content-Type"  = "application/json"
}

function global:au_GetLatest {
    $LatestRelease = Invoke-RestMethod -UseBasicParsing -Uri "https://api.github.com/repos/cyf/faforever/releases/latest" -Headers $headers
